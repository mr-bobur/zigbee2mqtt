...
import type HomeAssistant from "../../lib/extension/homeassistant";
...
describe("Extension: HomeAssistant", () => {
    ...
    beforeAll(async () => {
        ...
        z2mVersion = (await getZigbee2MQTTVersion()).version;
        version = `Zigbee2MQTT ${z2mVersion}`;
        origin.sw = z2mVersion;
        vi.useFakeTimers();
