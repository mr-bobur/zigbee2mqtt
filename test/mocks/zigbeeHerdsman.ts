...
const ts0601Thermostat = new Device(
    "EndDevice",
    "0x0017882104a44559",
    6544,
    4151,
...
const ts0601CoverSwitch = new Device(
    "EndDevice",
    "0x0017882104a44562",
    6544,
    4151,
...
export const groups = {
    ...
    thermostat_group: new Group(12, [ts0601Thermostat.endpoints[0]]),
...
export const devices = {
    ...
    TS0601_thermostat: ts0601Thermostat,
    TS0601_switch: ts0601Switch,
    TS0601_cover_switch: ts0601CoverSwitch,
